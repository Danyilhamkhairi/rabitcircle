...
@section('content')
	<!-- header end -->
	<div class="breadcrumb-area pt-30 breadcrumb-padding position-relative pb-30" style="background-image: url({{ asset('themes/images/slide1.jpg') }})">
	...
	<div class="container">
			<div class="breadcrumb-content text-center">
				<ul>
					...
					<li style="z-index: 9999;position: relative;color: #fff;">Checkout</li>
				</ul>
			</div>
		</div>
	</div>
						...
						<div class="payment-method">
							<div class="payment-accordion">
								...
								<div class="order-button-payment">
									<input type="submit" style="background-color: #1F82F3;" value="Place order" />
								</div>								
							</div>
						</div>
					</div>
