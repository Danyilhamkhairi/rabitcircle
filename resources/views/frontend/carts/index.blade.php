...
@section('content')
	<!-- header end -->
	<div class="breadcrumb-area pt-30 breadcrumb-padding pb-30 position-relative" style="background-image: url({{ asset('themes/images/slide1.jpg') }})">
	...
	<div class="container">
			<div class="breadcrumb-content text-center">
				<ul>
					...
					<li style="z-index: 9999;position: relative;color: #fff;"> Keranjang Belanja</li>
				</ul>
			</div>
		</div>
	</div>
