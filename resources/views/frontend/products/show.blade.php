...
@section('content')
	<div class="breadcrumb-area pt-30 position-relative pb-30" style="background-image: url({{ asset('themes/images/slide1.jpg') }})">
	...
	<div class="container">
			<div class="breadcrumb-content text-center">
				...
				<li><a style="color: #1F82F3;" href="{{ url('/') }}">home</a></li>
					<li style="z-index: 9999;position: relative;color: #fff;"> Detail Produk </li>
				</ul>
			</div>
		</div>
	</div>
