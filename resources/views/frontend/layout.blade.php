...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <header>
            <div style="background-color: #1F82F3;" class="header-top-furniture wrapper-padding-2 res-header-sm">
                <div class="container-fluid">
                    <div class="header-bottom-wrapper">
                        <div class="logo-2 furniture-logo ptb-30">
                            <a href="/">
                                <img src="{{ asset('themes/ezone/assets/img/logo/logo-11.png') }}" alt="">
                            </a>
                        </div>
                        <div class="menu-style-2 furniture-menu menu-hover">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="#" class="text-white">Mobile</a>
                                    ...
                                    <li><a href="{{ url('products') }}" class="text-white">shop</a>
                                    </li>
            ...
            <!-- <div class="footer-top-area pt-70 pb-35 wrapper-padding-5">
                <div class="container-fluid">
                    <div class="widget-wrapper">
                        ...
                        <div class="footer-widget mb-30">
                            <h3 class="footer-widget-title-5">Informasi Kontak</h3>
